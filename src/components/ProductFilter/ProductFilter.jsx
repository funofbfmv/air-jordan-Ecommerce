...
const Filter1 = () => {
    ...
    return (
        <div className="2xl:container 2xl md:block md:col-gap-1 lg:mx-screen z-5">
            <div className=" md:py-8  md:px-6 md:py-0 px-4">
                <div className=" flex justify-between items-center mb-2">
                    <h2 className=" lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 font-semibold"></h2>

                    {/*  filters Button (md and plus Screen) */}
                    <button onClick={() => setShowfilters(!showFilters)} className=" cursor-pointer sm:flex hidden hover:bg-gray-500 focus:ring focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 py-4 px-6 bg-gray-800 flex text-base leading-4 font-normal text-white justify-center items-center rounded-full duration-300">
                        <svg className=" mr-2 md:rounded-full" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button onClick={() => setShowfilters(!showFilters)} className="cursor-pointer rounded-full mt-6 block sm:hidden hover:bg-gray-700 focus:ring focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 py-2 w-full bg-gray-800 flex text-base leading-4 font-normal text-white justify-center items-center">
                    <svg className=" mr-2 rounded-full" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M6 12C7.10457 12 8 11.1046 8 10C8 8.89543 7.10457 8 6 8C4.89543 8 4 8.89543 4 10C4 11.1046 4.89543 12 6 12Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M6 4V8" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M6 12V20" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M12 18C13.1046 18 14 17.1046 14 16C14 14.8954 13.1046 14 12 14C10.8954 14 10 14.8954 10 16C10 17.1046 10.8954 18 12 18Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            ...
            <div id="filterSection" className={"shadow-lg rounded-lg relative md:py-10 lg:px-4 lg:mx-4 md:px-6 py-6 px-4 bg-gray-50 w-full " + (showFilters ? "block" : "hidden")}>
                {/* Cross button Code  */}
                <div onClick={() => setShowfilters(false)} className=" cursor-pointer absolute right-0 top-0 md:py-10 lg:px-4 lg:py-4 md:px-6 py-9 px-4">
                    <svg className=" lg:w-4 lg:h-4 w-4 h-4" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                    <div className=" flex space-x-2">
                        ...
                        <p className=" lg:text-2xl text-xl lg:leading-6 leading-5 font-medium text-gray-800 ">Выберите увет кроссовок</p>
                    </div>
                    <div className=" md:flex md:space-x-6 mt-8 grid grid-cols-3 gap-y-8 flex-wrap">
                        <div className=" flex space-x-2 md:justify-center md:items-center items-center justify-start ">
                            ...
                            <p className=" text-base leading-4 text-gray-600 font-normal">Белые</p>
                        </div>
                        <div className=" flex space-x-2 justify-center items-center">
                            <div className=" w-4 h-4 rounded-full bg-blue-600 shadow"></div>
                            <p className=" text-base leading-4 text-gray-600 font-normal">Синие</p>
                        </div>
                        <div className=" flex space-x-2 md:justify-center md:items-center items-center justify-end">
                            ...
                            <p className=" text-base leading-4 text-gray-600 font-normal">Красные</p>
                        </div>
                        <div className=" flex space-x-2 md:justify-center md:items-center items-center justify-start ">
                            <div className=" w-4 h-4 rounded-full bg-indigo-600 shadow"></div>
                            <p className=" text-base leading-4 text-gray-600 font-normal">Индиго</p>
                        </div>
                        <div className=" flex space-x-2 justify-center items-center">
                            <div className=" w-4 h-4 rounded-full bg-black shadow"></div>
                            <p className=" text-base leading-4 text-gray-600 font-normal">Черные</p>
                        </div>
                        <div className=" flex space-x-2 md:justify-center md:items-center items-center justify-end">
                            <div className=" w-4 h-4 rounded-full bg-purple-600 shadow"></div>
                            <p className=" text-base leading-4 text-gray-600 font-normal">Фиолетовые</p>
                        </div>
                        <div className=" flex space-x-2 md:justify-center md:items-center items-center justify-start">
                            <div className=" w-4 h-4 rounded-full bg-gray-600 shadow"></div>
                            <p className=" text-base leading-4 text-gray-600 font-normal">Серые</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div className=" flex space-x-2">
                        ...
                        <p className=" lg:text-2xl text-xl lg:leading-6 leading-5 font-medium text-gray-800 ">Материал</p>
                    </div>
                    <div className=" md:flex md:space-x-6 mt-8 grid grid-cols-3 gap-y-8 flex-wrap">
                        <div className=" flex space-x-2 md:justify-center md:items-center items-center justify-start">
                ...
                <div>
                    <div className=" flex space-x-2">
                        ...
                        <p className="  lg:text-2xl text-xl lg:leading-6 leading-5 font-medium text-gray-800 ">Размер</p>
                    </div>
                    <div className=" md:flex md:space-x-6 mt-8 grid grid-cols-3 gap-y-8 flex-wrap">
                ...
                <div>
                    <div className=" flex space-x-2">
                        ...
                        <p className=" lg:text-2xl text-xl lg:leading-6 leading-5 font-medium text-gray-800 ">Коллекция</p>
                    </div>
                ...
                <div className="px-0 mt-10 w-full md:w-auto lg:relative md:mt-0 md:absolute md:right-0 md:bottom-0 md:py-10 lg:px-20 md:px-4">
                    <button onClick={applyFilters} className="w-full hover:bg-gray-700 focus:ring focus:ring-offset-2 focus:ring-gray-800 text-base leading-4 font-medium py-4 px-10 text-white bg-gray-800 rounded">
                        Фильтровать
                    </button>
                </div>
            </div>
